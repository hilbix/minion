  ...
  show()
    {
      ...
      e.DIV.text(`JavaScript BroadcastsChannel demo version ${this.v}.`).br.A.href('broadcast.html').target().text('Open another window in the same browser to recv/send broadcast');
